...
public class Board {
    ...
    private final int[][] d = {{0,1,2,3,4,5,6,7,8,12,13,14,22},{17,26,35,16,25,34,15,24,33,14,23,32,22},{44,43,42,41,40,39,38,37,36,32,31,30,22},
        {9,18,27,10,19,28,11,20,29,12,21,30,22}};
    ...
    private int[][] tabxy = {{0,3},{0,4},{0,5},{1,3},{1,4},{1,5},{2,3},{2,4},{2,5},{3,0},{3,1},{3,2},{3,3},{3,4},{3,5},{3,6},{3,7},{3,8},
                             {4,0},{4,1},{4,2},{4,3},{4,4},{4,5},{4,6},{4,7},{4,8},
                             {5,0},{5,1},{5,2},{5,3},{5,4},{5,5},{5,6},{5,7},{5,8},{6,3},{6,4},{6,5},{7,3},{7,4},{7,5},{8,3},{8,4},{8,5}};
